 ...
 * Purpose: In-memory mock test doubles for fast, deterministic unit testing across packages.
...
// MockUserRepo provides an in-memory thread-safe UserRepository for testing.
type MockUserRepo struct {
	mu    sync.RWMutex
	users map[string]*User
}

// NewMockUserRepo creates a new mock user repository.
...
// MockSessionRepo provides an in-memory thread-safe SessionRepository.
...
// NewMockSessionRepo creates a new mock session repository.
...
// MockRolePermRepo provides an in-memory thread-safe RolePermissionRepository.
...
// NewMockRolePermRepo creates a new mock role and permissions repository.
...
// MockMFARepo provides an in-memory thread-safe MFARepository.
type MockMFARepo struct {
	mu          sync.RWMutex
	enrollments map[string]*MFAEnrollment
}

// NewMockMFARepo creates a new mock MFA repository.
